			...
			const kanbanSuccess = registerBasesView(
				...
				"tasknotesKanban",
				{
					...
					},
					{
						type: "text",
						key: "columnParents",
						displayName: "Column Parents",
						placeholder: "JSON object mapping column keys to parent column keys",
						default: "{}",
					},
					{
						type: "toggle",
						key: "enable2DLayout",
						displayName: "Enable 2D Layout",
						default: false,
					},
					{
						type: "text",
						key: "columnPositions",
						displayName: "Column Positions (Advanced)",
						placeholder: "JSON object mapping column keys to {r, c} coordinates",
						default: "{}",
					},
					],
				},
